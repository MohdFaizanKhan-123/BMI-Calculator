This is a BMI calculator which is developed through dart and flutter. It takes height(cm) and weight(kg) as input which gives bmi as an output and also tells whether the person is normal, extreme etc.
